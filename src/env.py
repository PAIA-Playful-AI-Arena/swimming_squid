...
BGM03_FILE_NAME = "bgm03.mp3"
BGM03_PATH = path.join(MUSIC_PATH, BGM03_FILE_NAME)
...
BGM03_URL = MUSIC_URL + BGM03_FILE_NAME
...
# ending
IMG_ID_CLEAR = "clear"
IMG_ID_FAILED = "failed"
CLEAR_PATH = path.join(ASSET_IMAGE_DIR, "clear.png")
FAILED_PATH = path.join(ASSET_IMAGE_DIR, "failed.png")
CLEAR_URL = ASSET_IMG_URL + "clear.png"
FAILED_URL = ASSET_IMG_URL + "failed.png"